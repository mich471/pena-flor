...
class EmailNotification implements EmailNotificationInterface
{
     ...
     * @throws MailException
     */
    protected function emailAndPasswordChanged(CustomerInterface $customer, $email)
    {
     ...
     * @throws NoSuchEntityException
     */
    protected function emailChanged(CustomerInterface $customer, $email)
    {
        $storeId = $customer->getStoreId();
        if (!$storeId) {
            $storeId = $this->getWebsiteStoreId($customer);
     ...
     * @throws NoSuchEntityException
     */
    protected function passwordReset(CustomerInterface $customer)
    {
        $storeId = $customer->getStoreId();
        if (!$storeId) {
            $storeId = $this->getWebsiteStoreId($customer);
    ...
    protected function sendEmailTemplate(
        ...
        //added to support multislte
        if (isset($templateParams['store'])) {
        ...
        $transport = $this->transportBuilder->setTemplateIdentifier($templateId)
            ...
            ->setFromByScope($this->scopeConfig->getValue($sender, 'store', $storeId), $storeId)
