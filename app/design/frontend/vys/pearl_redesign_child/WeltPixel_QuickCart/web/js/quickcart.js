define(['jquery', 'domReady',
   'Magento_Customer/js/model/authentication-popup',
    'Magento_Customer/js/customer-data'], function ($, domReady, authenticationPopup, customerData) {
    "use strict";
    ...
    var quickcart =
        {
            initialize: function(mobileBreakpoint) {
                ...
                $(document).on("mousedown", "#top-cart-btn-checkout", function(event){
            ...
            updateQty: function (el) {
                var qtyContainer = el.closest('.details-qty'),
                    ...
                    qtyIncrement = parseFloat($(".item-qty.cart-item-qty").attr("data-item-qty-increment"));

                if (el.hasClass('item-plus')) {
                    var newQty = currentQty + qtyIncrement;
                    this.updateItemQty(el, newQty);
                } else {
                    if (currentQty > qtyIncrement) {
                        var newQty = parseFloat(currentQty) - qtyIncrement;
                        this.updateItemQty(el, newQty);
                    } else {
