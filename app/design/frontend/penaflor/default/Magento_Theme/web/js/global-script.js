require([
    ...
    if($("body").hasClass("catalog-category-view")) {
        if($(".category-description").length) {
            ...
            if($(".category-description").height() > 43) {
                $(".category-description").addClass("closed");

                $("<div class='view-more'><a href='javascript:void(0)'>Ver más</a></div>").insertAfter($(".category-description"));

                $(".category-description").next(".view-more").andSelf().wrapAll("<div class='category-description-wrapper'></div>");
            }
        }
    }
